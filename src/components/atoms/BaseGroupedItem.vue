...
<template>
    <div class="ui:space-y-5">
        ...
        <div class="ui:flex ui:items-center ui:justify-between ui:flex-wrap ui:border-b ui:border-slate-200 ui:pb-4 ui:gap-y-3">
            <div class="ui:flex ui:items-center ui:gap-4 ">
                ...
                <div class="ui:min-w-0">
                    <h3 class="ui:text-2xl ui:font-black ui:text-slate-800 ui:uppercase ui:tracking-tight ui:truncate">
                        {{ title }}
                    </h3>
                    <a 
                        v-if="subtitle" 
                    ...
                    >
                        ...
                        <span class="ui:underline ui:decoration-dotted group-hover/address:ui:decoration-solid ui:truncate">
                            {{ subtitle }}
                        </span>
                    </a>
                </div>
            </div>
            <div class="ui:w-full ui:sm:w-auto">
